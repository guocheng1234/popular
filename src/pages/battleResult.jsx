...
export default class battleResult extends React.Component {
  ...
  async componentDidMount() {
    const inputIndex = this.props.history.location.search
      .slice(11)
      .indexOf("&playerTwo=");
    const input1 = this.props.history.location.search
      .slice(11)
      .substring(0, inputIndex);
    const input2 = this.props.history.location.search
      .slice(11)
      .substring(
        inputIndex + 11,
        this.props.history.location.search.slice(11).length
      );
