...
export default class Battle extends React.Component {
  ...
  routeChange = () => {
    ...
    this.props.history.push({
      ...
      search: `playerOne=${input1}&playerTwo=${input2}`,
      state: input1,
    });
  };
        ...
        <Row>
          <Col>
            ...
            {input1Show ? (
              ...
              <div className="inputShow">
                <img
                  src={`https://github.com/${input1}.png?size=200`}
          ...
          <Col>
            ...
            {input2Show ? (
              ...
              <div className="inputShow">
                <img
                  src={`https://github.com/${input2}.png?size=200`}
                  style={{ with: "50px", height: "50px" }}
                  alt=" "
                />
